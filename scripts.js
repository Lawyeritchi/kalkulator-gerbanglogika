document.addEventListener('DOMContentLoaded', () => {
    ...
    function createInputFields(operation) {
        mainWrapper.innerHTML = `
            ...
            <div class="main-input-wrapper">
                <form id="input-form" class="form-input">
                    ...
                    ${operation !== 'NOT' ? '<input type="text" class="num-input" id="input2" maxlength="1" />' : ''}
                </form>
        ...
        document.getElementById('calculateBtn').addEventListener('click', () => {
            ...
            const input2 = operation !== 'NOT' ? document.getElementById('input2').value : null;
    ...
    function calculateResult(input1, input2, operation) {
        ...
        if (isNaN(value1) || (input2 !== null && isNaN(value2)) || value1 < 0 || value1 > 9 || (value2 !== null && (value2 < 0 || value2 > 9))) {
